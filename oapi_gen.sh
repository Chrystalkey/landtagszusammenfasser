...
OPENAPI_GENERATOR_VERSION="7.11.0" ./$DIRECTORY/openapi-generator-cli generate -g python -i $(pwd)/docs/specs/openapi.yml -o $(pwd)/collector/oapicode
OPENAPI_GENERATOR_VERSION="7.11.0" ./$DIRECTORY/openapi-generator-cli generate -g python -i $(pwd)/docs/specs/openapi.yml -o $(pwd)/webserver/oapicode

OPENAPI_GENERATOR_VERSION="7.11.0" ./$DIRECTORY/openapi-generator-cli generate -g rust-axum -i $(pwd)/docs/specs/openapi.yml -o $(pwd)/database/oapicode
